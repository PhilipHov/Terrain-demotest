...
export default function App() {
  ...
  const cities = [
    ...
    { id: "fredericia", name: "Fredericia", coords: [55.5667, 9.75], zoom: 12 },
    {
      id: "frederikshavn",
      name: "Frederikshavn",
      coords: [57.441, 10.534],
      zoom: 12,
    },
    { id: "haderslev", name: "Haderslev", coords: [55.25, 9.5], zoom: 12 },
          ...
          .map((feature, index) => {
            ...
            return {
              ...
              properties: {
                ...
                originalName:
                  feature.properties.navn || feature.properties.name,
              },
            };
          });
  ...
  return (
    <div className="App-layout">
      ...
      <MapContainer className="map-container" center={[56.2, 9.0]} zoom={7}>
        <TileLayer
